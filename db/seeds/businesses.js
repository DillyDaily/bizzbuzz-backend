  ...
  return knex('businesses').del()
    .then(function () {
      ...
      return knex('businesses').insert([
        ...
        {company_name: 'Galvanize', first_name: 'Diana', last_name: 'Vowels', description: 'Our campus serves as a home base to start-ups and established companies building tech-enabled innovations and has all of the amenities of a co-working space.', email: 'diana@galvanize.com', password: 'galvanize1', image: 'https://s3.amazonaws.com/bizzbuzz/gLogo2.png', category: 'Instagram', topics: 'education, web, development, data science, data, learn', city: 'Phoenix', state: 'AZ'},
