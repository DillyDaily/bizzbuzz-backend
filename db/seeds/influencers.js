  ...
  return knex('influencers').del()
    .then(function () {
      ...
      return knex('influencers').insert([
        ...
        {personal_brand: 'Tenley Dene', first_name: 'Tenley', last_name: 'Murdock', description: "Come with me and you'll see a world of pure imagination", email: 'ten@ten.com', password: 'ten1', image: 'https://s3.amazonaws.com/bizzbuzz/gforum.png', topics: 'topic2, other, more, birds, hamsters', category: 'Instagram', city: 'Denver', state: 'CO' },
